...
Public Class Gadgets_XRP
    Private Price As String = Nothing
    Public Lock As Boolean = False

    Private Sub Gadgets_XRP_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        My.Settings.XRP_Position = Me.Location
        My.Settings.XRP_Lock = Lock
        My.Settings.Save()
    End Sub
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.Location = My.Settings.XRP_Position
        Lock = My.Settings.XRP_Lock
