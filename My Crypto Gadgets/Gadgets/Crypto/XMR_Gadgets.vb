...
Public Class Gadgets_XMR
    Private Price As String = Nothing
    Public Lock As Boolean = False

    Private Sub Gadgets_XMR_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        My.Settings.XMR_Position = Me.Location
        My.Settings.XMR_Lock = Lock
        My.Settings.Save()
    End Sub
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.Location = My.Settings.XMR_Position
        Lock = My.Settings.XMR_Lock
