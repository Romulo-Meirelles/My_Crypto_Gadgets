...
Public Class Gadgets_ETH
    Private Price As String = Nothing
    Public Lock As Boolean = False

    Private Sub Gadgets_BTC_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        My.Settings.ETH_Position = Me.Location
        My.Settings.ETH_Lock = Lock
        My.Settings.Save()
    End Sub
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.Location = My.Settings.ETH_Position
        Lock = My.Settings.ETH_Lock
